...
import com.ustcck.store.config.audit.AuditEventConverter;
import com.ustcck.store.domain.PersistentAuditEvent;
...
import static com.ustcck.store.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
