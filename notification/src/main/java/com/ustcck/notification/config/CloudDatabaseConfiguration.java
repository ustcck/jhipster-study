package com.ustcck.notification.config;
...
@Configuration
@EnableMongoRepositories("com.ustcck.notification.repository")
...
public class CloudDatabaseConfiguration extends AbstractCloudConfig {
    ...
    public Mongobee mongobee(MongoDbFactory mongoDbFactory, MongoTemplate mongoTemplate, Cloud cloud) {
        ...
        mongobee.setChangeLogsScanPackage("com.ustcck.notification.config.dbmigrations");
